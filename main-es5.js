...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(messageClient, dataClient) {
                ...
                AppComponent.prototype.ngOnInit = function () {
                    ...
                    this.messageClient.shareState$.asObservable()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.onDestroy$))
                        .subscribe(function () {
                        _this.sendState(_this.state);
                    });
                };
                AppComponent.prototype.setState = function (state) {
                    this.state = Object.assign({}, this.state, state);
                };
                AppComponent.prototype.setZoom = function (zoom) {
                    if (+zoom > 0) {
                        this.sendState({ zoom: +zoom });
                    }
                };
                AppComponent.prototype.setData = function ($event) {
                    this.state.numPages = +$event.numPages;
                };
                AppComponent.prototype.onGoToPage = function (pageInput) {
                ...
                AppComponent.prototype.setSessionAsUser = function (sessionForm) {
                ...
                AppComponent.prototype.setSessionAsAdmin = function (sessionForm) {
                    this.markAsDirty(sessionForm);
                    if (sessionForm.valid) {
                ...
                AppComponent.prototype.showCopyInfo = function () {
                    var _this = this;
                    this.copyText = 'OK!';
                    setTimeout(function () {
                        _this.copyText = 'Copy';
                ...
                AppComponent.prototype.getNextPageNr = function () {
                    return this.state.num + 1;
                };
                AppComponent.prototype.isNextAvailable = function () {
                    return this.getNextPageNr() <= this.state.numPages;
                };
                AppComponent.prototype.getPrevPageNr = function () {
                    return this.state.num - 1;
                };
                AppComponent.prototype.isPrevAvailable = function () {
                    return this.getPrevPageNr() > 0;
                };
                AppComponent.prototype.sendState = function (data) {
                    var state = Object.assign({}, this.state, data);
                    this.messageClient.sendState(this.session.id, state);
                };
                AppComponent.prototype.createSession = function (session, admin) {
                    this.messageClient.initializeWebSocketConnection(session, admin);
                };
                AppComponent.prototype.markAsDirty = function (form) {
                    Object.keys(form.controls).forEach(function (key) {
                        form.controls[key].markAllAsTouched();
                    });
                };
                AppComponent.prototype.checkServerStatus = function () {
                    var _this = this;
                    this.dataClient.getServerStatus()
                        .then((function (status) { return _this.serverStatus = status; }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DataClient = /** @class */ (function () {
                ...
                DataClient.prototype.getServerStatus = function () {
                    return this.checkServerStatus(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + '/status', 1000, 30);
                };
                DataClient.prototype.checkServerStatus = function (url, timeout, limit) {
                    var _this = this;
                    return fetch(url)
                        .then(function (response) {
                        if (response.ok && limit) {
                            setTimeout(_this.checkServerStatus, timeout, url, timeout, --limit);
                        }
                        else {
                            return false;
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MessageClient = /** @class */ (function () {
                ...
                MessageClient.prototype.initializeWebSocketConnection = function (session, admin) {
                    var _this = this;
                    console.log('initializeWebSocketConnection');
                    this.session$.next(session);
                    this.admin$.next(admin);
                    var ws = new sockjs_client__WEBPACK_IMPORTED_MODULE_3__(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + '/state');
                    this.stompClient = stompjs__WEBPACK_IMPORTED_MODULE_2__["over"](ws);
                    this.stompClient.connect({}, function (frame) {
                        _this.subscribeToSessionCommands(session.id);
                        admin
                            ? _this.subscribeToSessionDataAsAdmin(session)
                            : _this.subscribeToSessionDataAsUser(session.id);
                    });
                };
                MessageClient.prototype.subscribeToSessionCommands = function (sessionId) {
                    var _this = this;
                    console.log('subscribeToSessionCommands');
                    this.stompClient.subscribe('/topic/state/' + sessionId, function (message) {
                        if (message.body) {
                ...
                MessageClient.prototype.subscribeToSessionDataAsAdmin = function (sessionData) {
                    var _this = this;
                    console.log('subscribeToSessionDataAsAdmin');
                    this.src$.next(sessionData.url);
                    this.stompClient.subscribe('/topic/admin/init/' + sessionData.id, function (message) {
                        if (message.body) {
                            var user = JSON.parse(message.body);
                            // todo save user?
                            _this.sendMessage('/app/admin/init/' + sessionData.id, sessionData);
                            setTimeout(function () { return _this.shareState$.next(); }, 2000);
                        }
                    });
                };
                MessageClient.prototype.subscribeToSessionDataAsUser = function (sessionId) {
                    var _this = this;
                    console.log('subscribeToSessionDataAsUser');
                    this.stompClient.subscribe('/topic/init/' + sessionId, function (message) {
                        if (message.body) {
                            var session = JSON.parse(message.body);
                            _this.session$.next(session);
                        }
                    });
                    this.sendMessage('/app/init/' + sessionId, { id: '123', username: 'jankowal' });
                };
                MessageClient.prototype.sendState = function (sessionId, state) {
                    this.sendMessage('/app/state/' + sessionId, state);
                };
                MessageClient.prototype.sendMessage = function (path, data) {
